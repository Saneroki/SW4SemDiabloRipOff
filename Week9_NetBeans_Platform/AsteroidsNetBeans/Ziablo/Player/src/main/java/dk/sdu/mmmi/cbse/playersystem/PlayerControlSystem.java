...
public class PlayerControlSystem implements IEntityProcessingService {
    ...
    /**
     * Use SPILocator (or netbeans Lookup) to find all implementations of the ICreateBullet interface.
     * This way we don't have to add a physical Bullet JAR file. Instead we use
     * whiteboard model to our advantage.
     */
